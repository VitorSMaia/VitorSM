<div>
    ...
    <form wire:submit.prevent="save" class="grid gap-y-2">
        <label for="content" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Conteúdo</label>
        <textarea wire:model.defer="state.content" id="content" class="text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
