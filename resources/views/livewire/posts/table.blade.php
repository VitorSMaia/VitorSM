    ...
    <div class="mb-4 flex justify-between items-center">
        ...
        <div class="flex-1 pr-4">
            <div class="flex justify-end items-center">
                <button wire:click="openModal('posts.form')" class="hover:bg-green-500 hover:-translate-y-1 active:translate-y-1 bg-opacity-80 border border-emerald-500 px-3 py-2 rounded-md bg-green-400">Cadastrar</button>
            </div>
        </div>
    </div>
