    ...
    <div x-data="{ open: @entangle('showLoading') }">
      <!-- Loading screen -->
        <div
            ...
            x-show="open"
            x-transition
            class="bg-gray-700 bg-opacity-70 transition duration-150 ease-in-out fixed z-10"
        >
      ...
      <div
        class="flex flex-col items-center justify-center min-h-screen p-4 space-y-4 antialiased text-gray-900 "
      >
        <!-- Brand -->
        <a
          href="../index.html"
          class="inline-block mb-6 text-3xl font-bold tracking-wider uppercase text-primary-dark"
        >
          ADM
        </a>
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md">
            ...
            <form wire:submit.prevent="save" class="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  class="w-full px-4 py-2 font-medium text-center text-black border-2 border-blue-700 transition-colors duration-200 rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1"
                >
                  Login
                </button>
              </div>
