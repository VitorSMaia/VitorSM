<head>
    ...
    <td>
        <table class="es-content-body" align="center">
            <tbody>
            <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" class="esd-block-text">
                                            <h1>Parabéns, você recebeu um novo contato!</h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" class="esd-block-text es-p10t">
                                            <p>A {{ $request['name'] }} te enviou um nova menssagem vem olhar e já responder para ele/ela.<br></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" class="esd-block-text es-p10t">
